...
function TabPanel(props) {
    ...
    return (
        ...
        >
            {value === index && (
                <Box sx={{ maxHeight: 480, overflowY: 'scroll' }}>
                    {children}
                </Box>
            )}
        </div>
        ...
        <SidebarBox>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={tabValue} onChange={handleTabChange} variant='fullWidth'>
                    ...
                    <Tab label='User Assets' sx={{ pl: '0.75rem', pr: '0.75rem', fontSize: '0.75rem' }} disabled />
                </Tabs>
            </Box>
            <TabPanel value={tabValue} index={0}>
                <ListItem component='div' className='workspace-tab-header' disablePadding>
                    <ListItemButton>
                        <ListItemText
                        ...
                        <Stack direction='row' spacing={1}>
                            ...
                            </SidebarIconButton>
                            {
                                canEdit && (
                                    <SidebarIconButton>
                                        <AddOutlinedIcon fontSize='small' onClick={showAddResource} />
                                    </SidebarIconButton>
                                )
                            }
                        </Stack>
                ...
                <List>
                    <ListItemButton onClick={() => setOpenE(!openE)}>
                        <SidebarIconButton>
                            {openE ? <ExpandLess fontSize='small' /> : <ExpandMore fontSize='small' />}
                        </SidebarIconButton>
                        <ListItemText primary='NWB File' primaryTypographyProps={{
                            fontWeight: 600,
                            variant: 'body2',
                            pl: '0.286rem'
                        }} />
                    ...
                    {
                        openE && resources.filter(resource => resource.resourceType === 'e').map(resource =>
                            <ResourceItem disablePadding key={resource.id}
                                secondaryAction={
                    ...
                    <ListItemButton onClick={() => setOpenM(!openM)}>
                        <SidebarIconButton>
                            {openM ? <ExpandLess fontSize='small' /> : <ExpandMore fontSize='small' />}
                        </SidebarIconButton>
                        <ListItemText primary="NetPyNE model" primaryTypographyProps={{
                            fontWeight: 600,
                            variant: 'body2',
                            pl: '0.286rem'
                        }} />
                    ...
                    {
                        openM && resources.filter(resource => resource.resourceType === 'm').map(resource =>
                            <ResourceItem disablePadding key={resource.id} sx={{
                                '&:hover': {
                                    '& .MuiListItemSecondaryAction-root .MuiIconButton-root': {
                                        visibility: 'inherit'
                                    }
                    ...
                    <ListItemButton onClick={() => setOpenG(!openG)}>
                        <SidebarIconButton>
                            {openG ? <ExpandLess fontSize='small' /> : <ExpandMore fontSize='small' />}
                        </SidebarIconButton>
                        <ListItemText primary='Generic file' primaryTypographyProps={{
                            fontWeight: 600,
                            variant: 'body2',
                            pl: '0.286rem'
                        }} />
                    ...
                    {
                        openG && resources.filter(resource => resource.resourceType === 'g').map(resource =>
                            <ResourceItem disablePadding key={resource.id}
                                secondaryAction={
                                    <SidebarIconButton edge='end' aria-label='delete' sx={{ visibility: 'hidden' }}>
                                        <DeleteOutlinedIcon fontSize='small' />
                ...
                {
                   pendingResource && <ListItem component='div' className='workspace-tab-header' disablePadding sx={{
                        pointerEvents: 'none',
                        '&:hover': {
                            background: 'none',
                        }
