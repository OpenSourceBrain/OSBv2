...
class WorkspaceResourceEntity(Model):
    ...
    def __init__(self, id=None, name=None, folder=None, status=None, timestamp_created=None, timestamp_updated=None, timestamp_last_opened=None, resource_type=None, origin=None, workspace_id=None):  # noqa: E501
