...
class OSBRepositoryBase(Model):
    ...
    def __init__(self, id=None, name=None, summary=None, repository_type=None, content_types=None, auto_sync=True, uri=None, default_context=None, user_id=None, timestamp_created=None, timestamp_updated=None):  # noqa: E501
    ...
    def timestamp_created(self):
        """Gets the timestamp_created of this OSBRepositoryBase.

        Date/time the Workspace is created  # noqa: E501

        :return: The timestamp_created of this OSBRepositoryBase.
        :rtype: datetime
        """
    ...
    def timestamp_created(self, timestamp_created):
        """Sets the timestamp_created of this OSBRepositoryBase.

        Date/time the Workspace is created  # noqa: E501

        :param timestamp_created: The timestamp_created of this OSBRepositoryBase.
        :type timestamp_created: datetime
        """
    ...
    def timestamp_updated(self):
        """Gets the timestamp_updated of this OSBRepositoryBase.

        Date/time the Workspace is last updated  # noqa: E501

        :return: The timestamp_updated of this OSBRepositoryBase.
        :rtype: datetime
        """
    ...
    def timestamp_updated(self, timestamp_updated):
        """Sets the timestamp_updated of this OSBRepositoryBase.

        Date/time the Workspace is last updated  # noqa: E501

        :param timestamp_updated: The timestamp_updated of this OSBRepositoryBase.
        :type timestamp_updated: datetime
        """
