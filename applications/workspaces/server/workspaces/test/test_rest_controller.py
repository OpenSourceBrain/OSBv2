...
class TestRestController(BaseTestCase):
    ...
    def test_osbrepository_get(self):
        ...
        query_string = [('page', 1),
                        ...
                        ('user_id', 'ccfbe969-f7e2-4191-80c4-821dc5a97a28')]
        headers = { 
            'Accept': 'application/json',
        }
        response = self.client.open(
    ...
    def test_volumestorage_id_put(self):
        ...
        """
        volume_storage = {"name":"Storage Volume One","id":0}
        headers = { 
            'Accept': 'application/json',
            'Content-Type': 'application/json',
            'Authorization': 'Bearer special-key',
    ...
    def test_workspaces_controllers_workspace_controller_import_resources(self):
        ...
        """
        workspaces_controllers_workspace_controller_import_resources_request = workspaces.WorkspacesControllersWorkspaceControllerImportResourcesRequest()
        headers = { 
            'Content-Type': 'application/json',
            'Authorization': 'Bearer special-key',
        }
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(workspaces_controllers_workspace_controller_import_resources_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_workspaces_controllers_workspace_controller_workspace_clone(self):
        ...
        response = self.client.open(
            '/api/workspace/{id}/clone'.format(id=56),
            method='PUT',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
